...
class Picaro(Upgrade):
    ...
    min_produccion = Column(Integer, default=3000)  # Columna adicional para Picaro
    max_produccion = Column(Integer, default=35000)  # Columna adicional para Picaro
    ...
    def __init__(self, nombre, coste, min_produccion, max_produccion, produccion, efecto, incPrecio):
